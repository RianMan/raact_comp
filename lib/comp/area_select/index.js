...
var AddReceive = /*#__PURE__*/function (_React$Component) {
  _inherits(AddReceive, _React$Component);

  var _super = _createSuper(AddReceive);

  function AddReceive(props) {
    var _this;

    _classCallCheck(this, AddReceive);

    _this = _super.call(this, props);

    _defineProperty(_assertThisInitialized(_this), "handleChange", function (name, e) {
      console.log(e, 'eee');
      var selectedValue;
      ...
      switch (name) {
        case "province":
          _this.setState({
            ...
            cities: _this.getCity(selectedValue),
            city: _this.getCity(selectedValue)[0],
            county: _this.getCounty(selectedValue, _this.getCity(selectedValue)[0])[0],
            counties: _this.getCounty(selectedValue, _this.getCity(selectedValue)[0])
          });
        ...
        case "city":
          _this.setState({
            city: selectedValue,
            counties: _this.getCounty(_this.state.province, selectedValue),
            county: _this.getCounty(_this.state.province, selectedValue)[0]
          });
    ...
    _defineProperty(_assertThisInitialized(_this), "handleOk", function () {
      ...
      _this.props.handleControllerShow(false);
    });
    ...
    _this.state = {
      ...
      cities: _this.getCity('安徽'),
      counties: []
    };
    return _this;
  }

  _createClass(AddReceive, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      this.handleChange('province', '安徽');
      this.handleChange('city', '合肥');
      document.querySelector('body').style.overflow = 'hidden';
      var province = document.querySelector('#province');
      var provinceChildren = document.querySelectorAll('#province .item');
      var city = document.querySelector('#city');
      var county = document.querySelector('#county');
      var provinceTop = Array.from(provinceChildren).map(function (v) {
        return v.offsetTop;
      });
      console.log(provinceTop, 'provinceTop');
      province.addEventListener('scroll', function (e) {
    ...
    key: "getCity",
    value: function getCity(province) {
      var gc1 = [];
    ...
    key: "getCounty",
    value: function getCounty(province, city) {
      var gc2 = [];
      gc2['安徽'] = [];
    ...
    value: function render() {
      ...
      var _this$state = this.state,
          p = _this$state.province,
          ci = _this$state.city,
          co = _this$state.county;
      var _this$props = this.props,
          show = _this$props.show,
          handleControllerShow = _this$props.handleControllerShow;
      console.log(show, 'showAreaSelect');
      console.log(p, ci, co);
      var id = 0;
      return /*#__PURE__*/_react["default"].createElement(_rcAnimate["default"], {
        ...
        key: "1",
        className: _index["default"].area_mask
      }, /*#__PURE__*/_react["default"].createElement("div", {
        className: _index["default"].area_container
      }, /*#__PURE__*/_react["default"].createElement("div", {
        className: _index["default"].area_title
      }, /*#__PURE__*/_react["default"].createElement("div", {
        onClick: function onClick() {
          handleControllerShow(false);
        }
        ...
        className: _index["default"].select_container
      }, /*#__PURE__*/_react["default"].createElement("div", {
        id: "province",
        className: "".concat(_index["default"].province_select, " ").concat(_index["default"].select),
        ...
        id: "city",
        className: "".concat(_index["default"].city_select, " ").concat(_index["default"].select),
        onClick: this.handleChange.bind(this, "city")
      }, this.state.cities.map(function (city) {
        return /*#__PURE__*/_react["default"].createElement("div", {
          className: _index["default"].item,
          style: {
            color: ci === city ? '#FF981A' : ''
          },
          value: city,
          key: id++
        }, city);
        ...
        id: "county",
        className: "".concat(_index["default"].county_select, " ").concat(_index["default"].select),
        onClick: this.handleChange.bind(this, "county")
      }, this.state.counties.map(function (county) {
        return /*#__PURE__*/_react["default"].createElement("div", {
          className: _index["default"].item,
          style: {
            color: co === county ? '#FF981A' : ''
          },
          value: county,
          key: id++
        }, county);
